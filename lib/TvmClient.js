 ...
 * @property {number} retryMultiplier retry multiplier in milliseconds
 */
...
class TvmClient {
   ...
   * @param  {RetryOptions} [config.retryOptions] RetryOptions. Defaults to { maxRetries: 5, retryMultipler: 100}
