 ...
 * @property {string} partitionKey key to accessible cosmosdb partition
 * @property {string} containerId id to cosmosdb container where partition lives
 * @property {string} databaseId id to cosmosdb database where container lives
 * @property {string} expiration expiration date ISO/UTC
 *
 */
