...
*/
const { TvmError } = require('../lib/TvmError')
...
expect.extend({
  ...
  toThrowBadArgWithMessageContaining: (received, words) => toThrowWithCodeAndMessageContains(received, TvmError.codes.BadArgument, words),
  toThrowStatusError: (received, status) => toThrowWithCodeAndMessageContains(received, TvmError.codes.StatusError, [], status)
})
